...
/**
 * The concave corner is not something GTK/CSS can express cleanly here because the
 * islands need to visually "cut into" the transparent bar background. We draw the
 * shape manually and let CSS provide the color so theme.scss remains the styling
 * entrypoint for the surface that this curve belongs to.
 */
